    ...
    InputValid.prototype = {
            ...
            if (Boolean(data_valids)) {
                ...
                $.each(data_valids, function() {
                    if (Boolean(this.rule) && typeof this.rule === "string" && typeof self.methods[this.rule] === "function") {
                        ...
                        if (!self.methods[this.rule]($input.val(), this.value)) {
        ...
        methods:{
            ...
            email:function(value) {
                var regex = new RegExp("^([a-zA-Z0-9]+[_|_|.]?)*[a-zA-Z0-9]+@([a-zA-Z0-9]+[_|_|.]?)*[a-zA-Z0-9]+.[a-zA-Z]{2,3}$");
            ...
            phone_number:function(value){
            	var regex = new RegExp("^(\\d{11})|^((\\d{7,8})|(\\d{4}|\\d{3})-(\\d{7,8})|(\\d{4}|\\d{3})-(\\d{7,8})-(\\d{4}|\\d{3}|\\d{2}|\\d{1})|(\\d{7,8})-(\\d{4}|\\d{3}|\\d{2}|\\d{1}))$");
            	return regex.test($.trim(value));
            },
